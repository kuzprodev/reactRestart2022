...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const adv = document.querySelectorAll('.promo__adv img'), poster = document.querySelector('.promo__bg'),
        genre = document.querySelector('.promo__genre'), movieList = document.querySelector('.promo__interactive-list'),
        addForm = document.querySelector('form.add'), addInput = addForm.querySelector('.adding__input'),
    ...
    addForm.addEventListener('submit', (e) => {
        ...
        const favorite = checkbox.checked;// true/false
        if (newFilm) {
